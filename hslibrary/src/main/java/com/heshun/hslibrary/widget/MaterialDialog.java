...
public class MaterialDialog {
    ...
    public MaterialDialog(Context context, View v, String[] content) {
        this.mContext = context;
        signCode = (context.toString() + (null != content ? Arrays.toString(content) : "content")).hashCode();
    }
    ...
    public void dismiss() {
        ...
        mOnDismissListener.onDismiss(mAlertDialog);
        mAlertDialog = null;
    }
